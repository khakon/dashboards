var Customers = function () {
    ...
    var chartOptions = {
        ...
        legend: {
            ...
            customizeText: function() {
                return this.seriesName + " / " + Globalize.format(productsSales[this.seriesIndex].Sales / 1000000, "c1") + "M";
            }
        },
    ...
    self.changeRange = function () {
        var newYear = Globalize.format(new Date(self.startDate), "yyyy");
    ...
    self.init = function () {
        ...
        SaleViewer.sharedWidgets.initRange(function(e) {
            ...
            var newStartDate = Globalize.format(e.startValue, "yyyy-MM-dd"),
                newEndDate = Globalize.format(e.endValue, "yyyy-MM-dd");
...
$(function () {
    SaleViewer.customers = new Customers();
